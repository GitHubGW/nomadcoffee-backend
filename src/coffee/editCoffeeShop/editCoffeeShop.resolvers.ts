...
const resolvers: Resolvers = {
  Mutation: {
    editCoffeeShop: privateResolvers(
      async (_: any, { id, name, latitude, longitude, file, category }: EditCoffeeShopArgs, { prisma, loggedInUser }: Context): Promise<CommonResult> => {
        try {
          ...
          const foundCoffeeShop: CoffeeShopWithPhotoAndCategory = await prisma.coffeeShop.findFirst({
